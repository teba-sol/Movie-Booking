      ...
      <div class="container">
        ...
        <?php 
         ...
         if(mysqli_num_rows($verify_query) !=0 ){
            ...
            echo "<a href='book.php'><button class='btn'>get ticket</button>";
...
<img  style="width: 180px; height:190px; margin-left:100px;" src="images/signup.png" ><br>
            <header>  <div style="margin-left:150px;">Sign Up</div> </header>
